...
Portions Copyright (c) 2022-2042  Web Sharp Studios, Inc.
...
- GitHub: [https://github.com/websharpstudios/monero](https://github.com/websharpstudios/monero)
...
- Our [Vulnerability Response Process](https://github.com/websharpstudios/meta/blob/master/VULNERABILITY_RESPONSE_PROCESS.md) encourages responsible disclosure
...
| Coveralls | [![Coveralls Status](https://coveralls.io/repos/github/websharpstudios/monero/badge.svg?branch=master)](https://coveralls.io/github/websharpstudios/monero?branch=master)
...
```
git clone --recursive https://github.com/websharpstudios/monero
```
...
* To git clone, run:
    ...
    ```bash
    git clone --recursive https://github.com/websharpstudios/monero.git
    ```
...
* If you would like a specific [version/tag](https://github.com/websharpstudios/monero/tags), do a git checkout for that version. eg. 'v0.18.1.2'. If you don't care about the version and just want binaries from master, skip this step:
