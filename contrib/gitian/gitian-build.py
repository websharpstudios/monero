...
gsigs = 'https://github.com/websharpstudios/gitian.sigs.git'
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/websharpstudios/monero', help='Specify the URL of the repository. Default is %(default)s')
