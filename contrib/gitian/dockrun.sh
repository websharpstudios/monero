...
RUN	git clone https://github.com/websharpstudios/gitian.sigs.git sigs; \
  ...
  git clone https://github.com/websharpstudios/monero
...
if [ ! -d sigs ]; then
	git clone https://github.com/websharpstudios/gitian.sigs.git sigs
	cd sigs
