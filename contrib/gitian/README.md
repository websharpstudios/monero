...
fork the [gitian.sigs repository](https://github.com/websharpstudios/gitian.sigs) and clone it on your host machine, 
or pass the signed assert file back to your build machine.

```bash
git clone https://github.com/websharpstudios/gitian.sigs/
pushd gitian.sigs
...
[websharpstudios/gitian.sigs](https://github.com/websharpstudios/gitian.sigs/) repository:
